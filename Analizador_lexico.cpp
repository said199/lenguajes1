#include <iostream>
#include <string>//para agregar las cadenas
...
int main(){
    ...
    if (fichero==NULL) {// si fichero no falla coge un letra del fichero
    	...
    	for ( i = 0; i <200; i++){
			...
			while (longitud > i && Estado !=qe){
			    ...
			    switch (Estado){
			        ...
			        case q2: //si es un digito
                        if(Simbolo >= '0' && Simbolo <= '9'){
                            Estado= q3;
                        }
                        break;
                    
					case q3: //si es un digito
                        if(Simbolo >= '0' && Simbolo <= '9'){
                            Estado= q3;
                        }else{
		             	    if(Simbolo == '.'){
